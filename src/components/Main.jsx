const HomePage = () => {
    return (
      <div className="flex flex-col items-center bg-gradient-to-b from-blue-50 via-white to-blue-100 text-gray-800">
        {/* Add this style tag for the parallax effect */}
        <style>
          {`
            body {
            ...
            .parallax-bg {
              background-image: url('https://www.jotform.com/blog/wp-content/uploads/2019/10/how-to-make-a-website-featured-01.png'); /* Replace with your image URL */
        ...
        <div className="max-w-4xl text-center py-20 px-4 animate-fadeIn">
          ...
          <button className="bg-blue-600 text-white font-semibold py-3 px-8 rounded-full shadow-md transform transition-all duration-200 hover:bg-blue-700 hover:scale-105">
            Get Started
          </button>
        </div>
